...
public class MdbUpdateRepositoryImpl implements MdbUpdateRepository {
     ...
     */
    public void createWhenOuterEmpty(String appId, String innerPath, Map<String, Object> object) {
     ...
     */
    public void createWhenInnerExist(String outerPath, String innerPath, Map<String, Object> object) {
     ...
     */
    public void createWhenInnerEmpty(String appId, String outerPath, Map<String, Object> object) {
        // 先保存生成的view子文档
     ...
     * 路径用例："path": "app",
     */
    public void updateWhenOuterEmpty(String appId, String innerPath, Map<String, Object> object) {
        Query query = new Query(Criteria.where(Global.APP_ID).is(appId));
        List<PartPath> paths = pathConverter.pathForSetKey(innerPath);
     ...
     */
    public void updateWhenInnerExist(String outerPath, String innerPath, Map<String, Object> object) {
        Query query = new Query();
        List<ObjectId> targetDocIds = getFinalDocs(outerPath);
        for (ObjectId targetDocId : targetDocIds) {
            query.addCriteria(Criteria.where(Global.OBJECT_ID).is(targetDocId));
     ...
     */
    public void updateWhenInnerEmpty(String appId, String outerPath, Map<String, Object> object) {
        // 保留非特殊字段，批量修改
     ...
     */
    public void deleteWhenOuterEmpty(String appId, String innerPath) {
     ...
     */
    public void deleteWhenInnerExist(String appId, String outerPath, String innerPath) {
     ...
     */
    public void deleteWhenInnerEmpty(String appId, String outerPath) {
        // 先删除选中的view或者logic
        String rawPath = Global.APP + "." + outerPath;
